...
def test_INC_DP():
    ...
    cpu.fetch_decode_execute([0xE6, 0x34])
...
def test_INC_absolute():
    ...
    cpu.fetch_decode_execute([0xEE, 0x56, 0x34])
...
def test_INC_DP_indexed_X():
    ...
    cpu.fetch_decode_execute([0xF6, 0x30])
...
def test_INC_abs_indexed_X():
    ...
    cpu.fetch_decode_execute([0xFE, 0x00, 0x80])
