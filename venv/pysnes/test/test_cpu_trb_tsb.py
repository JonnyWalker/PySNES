...
def test_TRB_DP_16bit():
    ...
    cpu.fetch_decode_execute([0x14, 0x34])
...
def test_TRB_absolute_16bit():
    ...
    cpu.fetch_decode_execute([0x1C, 0x56, 0x34])
...
def test_TSB_DP_16bit():
    ...
    cpu.fetch_decode_execute([0x04, 0x34])
...
def test_TSB_absolute_16bit():
    ...
    cpu.fetch_decode_execute([0x0C, 0x56, 0x34])
...
def test_TSB_absolute_8bit():
    ...
    cpu.fetch_decode_execute([0x0C, 0xCD, 0xAB])
