...
def test_DEC_DP_Zero():
    ...
    cpu.fetch_decode_execute([0xC6, 0x34])
...
def test_DEC_absolute_Zero():
    ...
    cpu.fetch_decode_execute([0xCE, 0x56, 0x34])
...
def test_DEC_DP_indexed_X_Zero():
    ...
    cpu.fetch_decode_execute([0xD6, 0x30])
...
def test_DEC_abs_indexed_X_Zero():
    ...
    cpu.fetch_decode_execute([0xDE, 0x00, 0x80])
    assert cpu.cycles == 9
