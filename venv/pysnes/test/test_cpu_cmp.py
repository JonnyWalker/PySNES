...
def test_CMP_zero():
    ...
    cpu.fetch_decode_execute([0xC9, 0x34, 0x12])
...
def test_CMP_zero_8bit():
    ...
    cpu.fetch_decode_execute([0xC9, 0x12])
...
def test_CMP_negative():
    ...
    cpu.fetch_decode_execute([0xC9, 0x35, 0x12])
...
def test_CMP_negative_8bit():
    ...
    cpu.fetch_decode_execute([0xC9, 0x13])
...
def test_CMP_cflag():
    ...
    cpu.fetch_decode_execute([0xC9, 0x33, 0x12])
...
def test_CMP_cflag_8bit():
    ...
    cpu.fetch_decode_execute([0xC9, 0x11])
...
def test_CMP_DP_indexed_indirect_X():
    ...
    cpu.fetch_decode_execute([0xC1, 0x02])
...
def test_CMP_stack_relative():
    ...
    cpu.fetch_decode_execute([0xC3, 0x01])
...
def test_CMP_DP():
    ...
    cpu.fetch_decode_execute([0xC5, 0x34])
...
def test_CMP_DP_indirect_long():
    ...
    cpu.fetch_decode_execute([0xC7, 0x10])
...
def test_CMP_absolute():
    ...
    cpu.fetch_decode_execute([0xCD, 0x56, 0x34])
...
def test_CMP_long():
    ...
    cpu.fetch_decode_execute([0xCF, 0x56, 0x34, 0x12])
...
def test_CMP_DP_indirect_indexed_Y():
    ...
    cpu.fetch_decode_execute([0xD1, 0x10])
...
def test_CMP_DP_indirect():
    ...
    cpu.fetch_decode_execute([0xD2, 0x10])
...
def test_CMP_stack_relative_indirect_indexed_Y():
    ...
    cpu.fetch_decode_execute([0xD3, 0xFA])
    assert cpu.cycles == 8
    assert cpu.A == 0x1234
    assert cpu.P == 0b10000000
...
def test_CMP_DP_indexed_X():
    ...
    cpu.fetch_decode_execute([0xD5, 0x30])
...
def test_CMP_DP_indirect_long_indexed_Y():
    ...
    cpu.fetch_decode_execute([0xD7, 0x10])
...
def test_CMP_abs_indexed_Y():
    ...
    cpu.fetch_decode_execute([0xD9, 0x00, 0x80])
...
def test_CMP_abs_indexed_X():
    ...
    cpu.fetch_decode_execute([0xDD, 0x00, 0x80])
...
def test_CMP_long_indexed_X():
    ...
    cpu.fetch_decode_execute([0xDF, 0x00, 0x80, 0x80])
    assert cpu.cycles == 6
    assert cpu.A == 0xFFFF
    assert cpu.P == 0b00000001
...
def test_CPX_cflag():
    ...
    cpu.fetch_decode_execute([0xE0, 0x33, 0x12])
...
def test_CMP_DP():
    ...
    cpu.fetch_decode_execute([0xE4, 0x34])
...
def test_CPX_absolute():
    ...
    cpu.fetch_decode_execute([0xEC, 0x56, 0x34])
...
def test_CPY_cflag():
    ...
    cpu.fetch_decode_execute([0xC0, 0x33, 0x12])
...
def test_CPY_DP():
    ...
    cpu.fetch_decode_execute([0xC4, 0x34])
...
def test_CPY_absolute():
    ...
    cpu.fetch_decode_execute([0xCC, 0x56, 0x34])
