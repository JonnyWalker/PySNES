...
def test_AND_8bit_affect_16bit_zero():
    ...
    cpu.fetch_decode_execute([0x29, 0x00])
...
def test_AND_8Bit_affect16bit_negative():
    ...
    cpu.fetch_decode_execute([0x29, 0x80])
...
def test_AND_16Bit_constant_zero():
    ...
    cpu.fetch_decode_execute([0x29, 0x00, 0x00])
...
def test_AND_16Bit_constant_negative():
    ...
    cpu.fetch_decode_execute([0x29, 0xAB, 0xF0])
...
def test_AND_8Bit_constant_negative():
    ...
    cpu.fetch_decode_execute([0x29, 0xFB])
...
def test_AND_16Bit_constant_noflag():
    ...
    cpu.fetch_decode_execute([0x29, 0xBA, 0x0C])
...
def test_AND_8Bit_constant_noflag():
    ...
    cpu.fetch_decode_execute([0x29, 0x85])
...
def test_AND_DP_indexed_indirect_X():
    ...
    cpu.fetch_decode_execute([0x21, 0x02])
...
def test_AND_DP_indexed_indirect_X2():
    ...
    cpu.fetch_decode_execute([0x21, 0xFE])
...
def test_AND_stack_relative():
    ...
    cpu.fetch_decode_execute([0x23, 0x01])
...
def test_AND_stack_relative2():
    ...
    cpu.fetch_decode_execute([0x23, 0xFA])
...
def test_AND_DP():
    ...
    cpu.fetch_decode_execute([0x25, 0x34])
...
def test_AND_DP2():
    ...
    cpu.fetch_decode_execute([0x25, 0xFF])
...
def test_AND_DP_indirect_long():
    ...
    cpu.fetch_decode_execute([0x27, 0x10])
...
def test_AND_DP_indirect_long2():
    ...
    cpu.fetch_decode_execute([0x27, 0xFE])
...
def test_AND_absolute():
    ...
    cpu.fetch_decode_execute([0x2D, 0x56, 0x34])
...
def test_AND_absolute2():
    ...
    cpu.fetch_decode_execute([0x2D, 0xFF, 0xFF])
...
def test_AND_long():
    ...
    cpu.fetch_decode_execute([0x2F, 0x56, 0x34, 0x12])
...
def test_AND_long2():
    ...
    cpu.fetch_decode_execute([0x2F, 0xFF, 0xFF, 0x12])
...
def test_AND_DP_indirect_indexed_Y():
    ...
    cpu.fetch_decode_execute([0x31, 0x10])
...
def test_AND_DP_indirect_indexed_Y2():
    ...
    cpu.fetch_decode_execute([0x31, 0xFF])
...
def test_AND_DP_indirect():
    ...
    cpu.fetch_decode_execute([0x32, 0x10])
...
def test_AND_DP_indirect2():
    ...
    cpu.fetch_decode_execute([0x32, 0xFF])
...
def test_AND_stack_relative_indirect_indexed_Y():
    ...
    cpu.fetch_decode_execute([0x33, 0xFA])
    assert cpu.cycles == 8
    assert cpu.A == 0x0220
    assert cpu.P == 0b00000000
    assert cpu.PC == 2
...
def test_AND_DP_indexed_X():
    ...
    cpu.fetch_decode_execute([0x35, 0x30])
...
def test_AND_DP_indexed_X2():
    ...
    cpu.fetch_decode_execute([0x35, 0xFE])
...
def test_AND_DP_indirect_long_indexed_Y():
    ...
    cpu.fetch_decode_execute([0x37, 0x10])
...
def test_AND_DP_indirect_long_indexed_Y2():
    ...
    cpu.fetch_decode_execute([0x37, 0xFE])
...
def test_AND_abs_indexed_Y():
    ...
    cpu.fetch_decode_execute([0x39, 0x00, 0x80])
...
def test_AND_abs_indexed_Y2():
    ...
    cpu.fetch_decode_execute([0x39, 0xFE, 0xFF])
...
def test_AND_abs_indexed_X():
    ...
    cpu.fetch_decode_execute([0x3D, 0x00, 0x80])
...
def test_AND_abs_indexed_X2():
    ...
    cpu.fetch_decode_execute([0x3D, 0xFE, 0xFF])
    assert cpu.cycles >= 6
    assert cpu.A == 0x0F0F
    assert cpu.P == 0b00000000
    assert cpu.PC == 3
...
def test_AND_long_indexed_X():
    ...
    cpu.fetch_decode_execute([0x3F, 0x00, 0x80, 0x80])
    assert cpu.cycles == 6
    assert cpu.A == 0xCDAB
    assert cpu.P == 0b10000000
    assert cpu.PC == 4
...
def test_AND_long_indexed_X2():
    ...
    cpu.fetch_decode_execute([0x3F, 0xFE, 0xFF, 0x12])
