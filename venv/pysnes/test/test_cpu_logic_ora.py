...
def test_ORA_8bit_affect_16bit_zero():
    ...
    cpu.fetch_decode_execute([0x09, 0x00])
...
def test_ORA_8Bit_affect16bit_negative():
    ...
    cpu.fetch_decode_execute([0x09, 0x80])
...
def test_ORA_16Bit_constant_zero():
    ...
    cpu.fetch_decode_execute([0x09, 0x00, 0x00])
...
def test_ORA_16Bit_constant_negative():
    ...
    cpu.fetch_decode_execute([0x09, 0xAB, 0x80])
...
def test_ORA_8Bit_constant_negative():
    ...
    cpu.fetch_decode_execute([0x09, 0xFB])
...
def test_ORA_16Bit_constant_noflag():
    ...
    cpu.fetch_decode_execute([0x09, 0xBA, 0x0C])
...
def test_ORA_8Bit_constant_noflag():
    ...
    cpu.fetch_decode_execute([0x09, 0x75])
...
def test_ORA_DP_indexed_indirect_X():
    ...
    cpu.fetch_decode_execute([0x01, 0x02])
...
def test_ORA_DP_indexed_indirect_X2():
    ...
    cpu.fetch_decode_execute([0x01, 0xFE])
...
def test_ORA_stack_relative():
    ...
    cpu.fetch_decode_execute([0x03, 0x01])
...
def test_ORA_stack_relative2():
    ...
    cpu.fetch_decode_execute([0x03, 0xFA])
...
def test_ORA_DP():
    ...
    cpu.fetch_decode_execute([0x05, 0x34])
...
def test_ORA_DP2():
    ...
    cpu.fetch_decode_execute([0x05, 0xFF])
...
def test_ORA_DP_indirect_long():
    ...
    cpu.fetch_decode_execute([0x07, 0x10])
...
def test_ORA_DP_indirect_long2():
    ...
    cpu.fetch_decode_execute([0x07, 0xFE])
...
def test_ORA_absolute():
    ...
    cpu.fetch_decode_execute([0x0D, 0x56, 0x34])
...
def test_ORA_absolute2():
    ...
    cpu.fetch_decode_execute([0x0D, 0xFF, 0xFF])
...
def test_ORA_long():
    ...
    cpu.fetch_decode_execute([0x0F, 0x56, 0x34, 0x12])
...
def test_ORA_long2():
    ...
    cpu.fetch_decode_execute([0x0F, 0xFF, 0xFF, 0x12])
...
def test_ORA_DP_indirect_indexed_Y():
    ...
    cpu.fetch_decode_execute([0x11, 0x10])
...
def test_ORA_DP_indirect_indexed_Y2():
    ...
    cpu.fetch_decode_execute([0x11, 0xFF])
...
def test_ORA_DP_indirect():
    ...
    cpu.fetch_decode_execute([0x12, 0x10])
...
def test_ORA_DP_indirect2():
    ...
    cpu.fetch_decode_execute([0x12, 0xFF])
...
def test_ORA_stack_relative_indirect_indexed_Y():
    ...
    cpu.fetch_decode_execute([0x13, 0xFA])
    assert cpu.cycles == 8
    assert cpu.A == 0x5335
    assert cpu.P == 0b00000000
    assert cpu.PC == 2
...
def test_ORA_DP_indexed_X():
    ...
    cpu.fetch_decode_execute([0x15, 0x30])
...
def test_ORA_DP_indexed_X2():
    ...
    cpu.fetch_decode_execute([0x15, 0xFE])
...
def test_ORA_DP_indirect_long_indexed_Y():
    ...
    cpu.fetch_decode_execute([0x17, 0x10])
...
def test_ORA_DP_indirect_long_indexed_Y2():
    ...
    cpu.fetch_decode_execute([0x17, 0xFE])
...
def test_ORA_abs_indexed_Y():
    ...
    cpu.fetch_decode_execute([0x19, 0x00, 0x80])
...
def test_ORA_abs_indexed_Y2():
    ...
    cpu.fetch_decode_execute([0x19, 0xFE, 0xFF])
...
def test_ORA_abs_indexed_X():
    ...
    cpu.fetch_decode_execute([0x1D, 0x00, 0x80])
...
def test_ORA_abs_indexed_X2():
    ...
    cpu.fetch_decode_execute([0x1D, 0xFE, 0xFF])
    assert cpu.cycles >= 6
    assert cpu.A == 0xFFFF
    assert cpu.P == 0b10000000
    assert cpu.PC == 3
...
def test_ORA_long_indexed_X():
    ...
    cpu.fetch_decode_execute([0x1F, 0x00, 0x80, 0x80])
    assert cpu.cycles == 6
    assert cpu.A == 0xFFFF
    assert cpu.P == 0b10000000
    assert cpu.PC == 4
...
def test_ORA_long_indexed_X2():
    ...
    cpu.fetch_decode_execute([0x1F, 0xFE, 0xFF, 0x12])
